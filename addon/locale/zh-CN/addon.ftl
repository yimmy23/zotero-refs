...
row-details = 详情
row-details-tip = 打开详情 · 引文处按 Alt+Enter · Escape 返回
retracted-badge = 已撤稿
...
panel-refresh = 刷新
panel-edits-preserved = 已保留编辑后的列表：刷新结果中部分引用无法唯一匹配
panel-actions = 更多
...
citations-ready = 点击“加载更多”获取引用本文的文献。
panel-partial = 部分结果
panel-pdf-pending = 已有结果 · PDF 仍在加载
