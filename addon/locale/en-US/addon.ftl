...
related-refresh-tip = Fetch fresh recommendations
...
row-details = Details
row-details-tip = Open details · Alt+Enter from the citation · Escape to return
...
panel-edits-preserved = Kept your edited list: some citations could not be matched after refresh
panel-actions = More
...
citations-ready = Use Load more to fetch papers citing this item.
panel-partial = Partial results
panel-pdf-pending = Available results · PDF still loading
